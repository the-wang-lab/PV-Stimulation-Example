...
%% for each stim condition, calculate the changes in the peak location for each pyrRise and pyrDown neuron
%% and the time constants of their ramping dynamics 
