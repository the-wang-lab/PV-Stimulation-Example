function InterneuronInitPeakAllRec(pathS,taskSel,methodKMean)
%% accumulating the information about the average firing rate profile for individual interneurons across recordings
%% data aligned to run onset
%% non stim trials, separating into good and bad trials  
        
    RecordingListPyrInt;
    pathAnal0 = [pathS '\Interneuron\'];
    pathAnal1 = [pathS '\Interneuron\' num2str(methodKMean) '\'];
