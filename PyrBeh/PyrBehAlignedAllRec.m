function PyrBehAlignedAllRec(pathS,onlyRun,task)
...
%% Data aligned to run onset
    ...
    if(task == 1) % including all the neurons
        pathAnal = [pathS '\PyramidalBeh\'];
    elseif(task == 2) % including AL and PL neurons
        pathAnal = [pathS '\PyramidalBehALPL\'];
    else
        pathAnal = [pathS '\PyramidalBehAL\'];
    end
...
%     end
    ...
    behAlignedMeanFieldStat = accumMeanBehStat(behAlignedMeanField,behAlignedAL.spaceStepsLick,...
