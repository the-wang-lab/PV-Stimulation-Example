...
%% theta modulation, burstness and whether there is a field, activity correlation across recordings
%% Data are aligned to run onset 
%% only consider good/bad trials
%% This function is called by PyrModAlignedAllRec_GoodTr
