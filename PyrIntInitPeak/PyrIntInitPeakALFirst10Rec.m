function PyrIntInitPeakALFirst10Rec(pathS,taskSel)
...
%% only look at the first 10 recordings of the AL task, where the speed is matched with passive no cue task
    ...
    pathAnalPeak0 = [pathS '\PyramidalInitPeak\2\'];
    ...
    elseif(taskSel == 4)
        pathAnal = [pathS '\PyramidalIntInitPeakNoCue\'];
    elseif(taskSel == 5)
        pathAnal = [pathS '\PyramidalIntInitPeakAL10\'];
    end
