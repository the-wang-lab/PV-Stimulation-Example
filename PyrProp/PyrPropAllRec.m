function PyrPropAllRec(pathS,onlyRun)
%% Accumulate information about individual pyramidal neurons' spiking properties 
%% across recordings, Classify neurons based on spike ccg and theta phase histogram

    RecordingListPyrInt; % include all the NoCue, PL and AL (up to A057)
    ...
    %     [autoCorrPyrAL.idxC,autoCorrPyrAL.klust] = kmeansInterneurons(autoCorrPyrAL);
        ...
        %% accumulate neurons from different task types
        ...
        %% classify neurons based on their spiking properties
