...
%     ProcessingAlignedBehTime(listRecordingsNoCuePath(i,:),listRecordingsNoCueFileName(i,:),onlyRun,mazeSessionNoCue(i));
%     ProcessingAlignedBehTime(listRecordingsNoCuePath(i,:),listRecordingsNoCueFileName(i,:),0,mazeSessionNoCue(i));
end
...
%     ProcessingAlignedBehTime(listRecordingsActiveLickPath(i,:),listRecordingsActiveLickFileName(i,:),onlyRun,mazeSessionActiveLick(i));
%     ProcessingAlignedBehTime(listRecordingsActiveLickPath(i,:),listRecordingsActiveLickFileName(i,:),0,mazeSessionActiveLick(i));
    rewardDisAligned(listRecordingsActiveLickPath(i,:),listRecordingsActiveLickFileName(i,:),0,mazeSessionActiveLick(i))
end
...
%     ProcessingAlignedBehTime(listRecordingsPassiveLickPath(i,:),listRecordingsPassiveLickFileName(i,:),onlyRun,mazeSessionPassiveLick(i));
%     ProcessingAlignedBehTime(listRecordingsPassiveLickPath(i,:),listRecordingsPassiveLickFileName(i,:),0,mazeSessionPassiveLick(i));
% end
...
%     ProcessingAlignedBehTime(listRecordingsPassiveLickBlackoutNoCuePath(i,:),listRecordingsPassiveLickBlackoutNoCueFileName(i,:),onlyRun,mazeSessionPassiveLickBlackoutNoCue(i));
%     ProcessingAlignedBehTime(listRecordingsPassiveLickBlackoutNoCuePath(i,:),listRecordingsPassiveLickBlackoutNoCueFileName(i,:),0,mazeSessionPassiveLickBlackoutNoCue(i));
% end

% numRec = size(listRecordingsCueRichPath,1);
% for i = 6:numRec
%     disp(listRecordingsCueRichPath(i,:))
%     cd(listRecordingsCueRichPath(i,:));
%     ProcessingMice_smTr(listRecordingsCueRichPath(i,:),listRecordingsCueRichFileName(i,:),onlyRun);
%     ProcessingMice_smTrSpeedLick(listRecordingsCueRichPath(i,:),listRecordingsCueRichFileName(i,:),onlyRun,mazeSessionCueRich(i));
%     disp(listRecordingsCueRichPath(i,:))
%     ProcessingMice_smTr_GoodTr(listRecordingsCueRichPath(i,:),listRecordingsCueRichFileName(i,:),onlyRun,mazeSessionCueRich(i));
%     disp(listRecordingsCueRichPath(i,:))
%     ProcessingMice_smTrCtrlOnly(listRecordingsCueRichPath(i,:),listRecordingsCueRichFileName(i,:),onlyRun,mazeSessionCueRich(i));
%     FieldWidthLR_GoodTr(listRecordingsCueRichPath(i,:),listRecordingsCueRichFileName(i,:),20,1,2,0,...
%         onlyRun,mazeSessionCueRich(i));
% %     pause;
%     close all;
%     disp(listRecordingsCueRichPath(i,:))
%     ProcessingAligned(listRecordingsCueRichPath(i,:),listRecordingsCueRichFileName(i,:),onlyRun,mazeSessionCueRich(i),4);
%     disp(listRecordingsCueRichPath(i,:))
%     ProcessingAlignedRun0(listRecordingsCueRichPath(i,:),listRecordingsCueRichFileName(i,:),mazeSessionCueRich(i),4);
%     close all;
%     disp(listRecordingsCueRichPath(i,:))
%     FieldWidthLRAligned(listRecordingsCueRichPath(i,:),listRecordingsCueRichFileName(i,:),1,0,onlyRun,mazeSessionCueRich(i)); 
%     ProcessingAlignedCtrlOnly(listRecordingsCueRichPath(i,:),listRecordingsCueRichFileName(i,:),onlyRun,mazeSessionCueRich(i));
%     ProcessingAlignedCtrlOnlyRun0(listRecordingsCueRichPath(i,:),listRecordingsCueRichFileName(i,:),mazeSessionCueRich(i));
%     ProcessingAlignedBehTime(listRecordingsCueRichPath(i,:),listRecordingsCueRichFileName(i,:),onlyRun,mazeSessionCueRich(i));
%     ProcessingAlignedBehTime(listRecordingsCueRichPath(i,:),listRecordingsCueRichFileName(i,:),0,mazeSessionCueRich(i));
% end
