...
%     FieldWidthLR_GoodTr(listRecordingsNoCuePath(i,:),listRecordingsNoCueFileName(i,:),20,1,0,0,...
...
for i = 1:numRec
    ...
    FieldWidthLR_GoodTr(listRecordingsActiveLickPath(i,:),listRecordingsActiveLickFileName(i,:),20,1,0,0,...
...
%     FieldWidthLR_GoodTr(listRecordingsPassiveLickPath(i,:),listRecordingsPassiveLickFileName(i,:),20,1,0,0,...
