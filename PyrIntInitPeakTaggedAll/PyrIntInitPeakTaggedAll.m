function PyrIntInitPeakTaggedAll(pathS)
%% for tagged PV cells
%% compare Pyramidal neurons and interneurons on their initial peak (including all the recordings where the number of good trials >= minNumTr...
...
%% firing rate change and comparing avgProfile. Use PyrIntInitPeakTagged for that (where the neurons with >= minNumTr bad trials are considered)
    ...
    pathAnal = [pathS '\PyramidalIntInitPeakTaggedAll\'];
