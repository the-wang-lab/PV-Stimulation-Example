function PyrInitPeakAllStimPVRecSigNonStim2ndStimCtrlTr(pathS,methodKMean)
%% only consider stimulation recordings
%% accumulating information about the averaged firing rate profile of pyramidal neurons
%% data aligned to run onset
%% including good trials from non-stim ctrl and 2nd stim ctrl as ctrl trials, 
%% stim ctrl trials are the second stim ctrl trials from all the stim pulse types from the recording
    ...
    pathAnal = [pathS '\PyramidalStimALNonStim2ndStimCtrlSig\2\'];
